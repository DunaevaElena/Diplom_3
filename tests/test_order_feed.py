...
class TestSectionOrderFeed:
    ...
    @allure.title('Проверка открытия модального окна с деталями по клику на заказ в ленте заказов')
    ...
    def test_displaying_orders_from_order_history(self, user, logged,
    ...
    def test_increases_completed_for_all_time_counter(self, user, logged, header, index_page,
                                                                           order_feed_page):
    ...
    def test_order_number_appears_in_section_in_progress(self, user, logged, header,
